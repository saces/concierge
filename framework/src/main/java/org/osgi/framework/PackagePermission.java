...
public final class PackagePermission extends BasicPermission {
	...
	private static final int ACTION_EXPORT = 0x00000001;
	 ...
	 *            Package name.
	 * @param actions
	 *            <tt>EXPORT</tt>, <tt>IMPORT</tt> (canonical order).
	 */

	public PackagePermission(final String name, final String actions) {
	 ...
	 *            mask
	 */
	PackagePermission(final String name, final int mask) {
		super(name);
		if (name == null) {
...
final class PackagePermissionCollection extends PermissionCollection {
	 ...
	 * 
	 * @param permission
	 *            The <tt>PackagePermission</tt> object to add.
	 * 
	 * @exception IllegalArgumentException
	 *                If the permission is not a <tt>PackagePermission</tt>
	 *                instance.
	 * 
	 * @exception SecurityException
	 *                If this <tt>PackagePermissionCollection</tt> object has
