...
public final class ServicePermission extends BasicPermission {
	...
	private static final int ACTION_REGISTER = 0x00000002;

	private static final int ACTION_ALL = ACTION_GET | ACTION_REGISTER;

	private static final int ACTION_NONE = 0;

	private static final int ACTION_ERROR = 0x80000000;
	 ...
	 *            class name
	 * @param actions
	 *            <tt>get</tt>, <tt>register</tt> (canonical order)
	 */

	public ServicePermission(final String name, final String actions) {
	 ...
	 *            mask
	 */
	ServicePermission(final String name, final int mask) {
		super(name);
		if (name == null) {
...
final class ServicePermissionCollection extends PermissionCollection {
	 ...
	 *                If the permission is not a ServicePermission object.
	 * 
	 * @exception SecurityException
	 *                If this <tt>ServicePermissionCollection</tt> object has
