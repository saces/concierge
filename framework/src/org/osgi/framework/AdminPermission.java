...
public final class AdminPermission extends BasicPermission {
	 ...
	 * 
	 * @param name
	 *            Ignored; always set to "AdminPermission".
	 * @param actions
	 *            Ignored.
	 */
	public AdminPermission(final String name, final String actions) {
		this();
	}
...
final class AdminPermissionCollection extends PermissionCollection {
	 ...
	 * 
	 * @param permission
	 *            The <tt>Permission</tt> object to add.
	 * 
	 * @exception IllegalArgumentException
	 *                If the permission is not an <tt>AdminPermission</tt>.
	 * 
	 * @exception SecurityException
	 *                If this AdminPermissionCollection object has been marked
	 *                read-only.
	 */
